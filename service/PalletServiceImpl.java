...
public class PalletServiceImpl implements PalletService {
	static final Logger log = LogManager.getLogger(PalletServiceImpl.class);
    ...
    //@Override
   // public String getListStatiFiltroRicercaElencoStatoPallet(Request<RequestStatiFiltroRicercaElencoPallet> request) throws MalformedURLException, IOException, Exception {
     //   return null;
    //}

    @Override
    public String getListStatiFiltroRicercaElencoStatoPallet(Request<RequestStatiFiltroRicercaElencoPallet> request)	throws MalformedURLException, IOException, Exception {
        log.info("getListStatiFiltroRicercaElencoStatoPallet start");
...
//		Response<ResponsePaginationAndValueObj> responseGUI = new Response<ResponsePaginationAndValueObj>();
        ...
        ResponseDynamicTable respByService = (ResponseDynamicTable) RESTfulClient.sendPost(urlBancServicePallet("getListStatiFiltroRicercaElencoStatoPallet"), request,
        ...
        for (Map<String, Object> map : dataRowCon) {
            ...
            Double typeId = (Double) map.get(ScatolaCostants.NConf_SCATOLA_ID.fieldDB());
