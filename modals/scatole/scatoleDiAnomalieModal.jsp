<div class="modal fade" id="scatoleDiAnomalieModal" style="overflow-y:auto; tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      ...
      <div class="modal-content">      
         ...
         <div class="modal-body">
            ...
            <input type="hidden" id="id" />
             <input type="hidden" id="codScatola" />
                    ...
                    <div class="row">   
                          ...
                          <div class="col-lg-2 col-md-4">
                          	  <div>
	                              ...
	                              <input type="text" id="codNazUpdModal" class="form-control is-valid" required />				      
                          	  </div>
                          </div>
                          </div>
                          <hr>
                           <div class="row">
	                          ...
	                          <div class="row">
	                             <div class="col-lg-4 col-md-4">
	                          	  <div>
		                              <label for="codRaccAddModal">Codice Raccomandata </label>
		                              <input type="text" id="codRaccAddModal" class="form-control is-valid" required maxlength="12"/>				      
	                          	  </div>
	                          </div>
	                            <div class="col-lg-8 col-md-4">
	                          	  <div>
		                              <label for="noteAddModal">Note </label>
		                              <input type="text" id="noteAddModal" class="form-control is-valid" required />				      
	                          	  </div>
	                          </div>
            ...
            <button type="button" class="btn btn-primary" id="spedisciScatola">Spedisci Scatola</button>
            <!--  <button type="button" class="btn btn-primary" id="confermaAggiorna">Aggiorna</button>-->
			<button type="button" class="btn btn-secondary" data-dismiss="modal">Chiudi</button>
           </div>
</div>
<script src="${pageContext.servletContext.contextPath}/resources/template/js/scatole/scatoleDiAnomalieModal.js"></script>