<div class="modal fade" id="distintaPacchettoModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered" style="width: 1200px;top:150px;" role="document">

      <div class="modal-content">
           <div class="modal-header" style="text-align: center">
               <h4><label id="print_loadPacchetto" class="label label-info"></label></h4>    			
          </div>
          <div class="modal-body">
				<input type="hidden" id="codicePacchetto"/>
<!--  		   <div class="row">
                <div class="col-lg-12"> -->
 ...
 <!--                           <div class="table-responsive"> -->
					       <div id="printableAreaPacchetto" class="printable">
                                <table style="border:0px">
                                   	 <!--  <thead></thead> -->
									 <tbody>
									 	<tr><td align="center" colspan="4">
									 		<img src=""  id="imgBcDistintaPacchetto" width="300"></img>								 	
									 	</td></tr>
										<tr><td>&nbsp;</td></tr>
										<tr><td>&nbsp;</td></tr>
										<tr>
                                ...
                                <table class="table table-bordered" id="tableRaccomandateDistPacchetto" >
                                   	 <thead>
                                   	 	<tr>
                          ...
                          <!--  </div> -->
						   ...
						   <div class="modal-footer"  style="text-align:center">
						        <button type="button" class="btn btn-primary" id="stampaPacchetto">Stampa</button>
...
<script
   src="${pageContext.servletContext.contextPath}/resources/template/js/scatole/distintaPacchettoModal.js"></script>