...
public class AggiungiIndiceForm {

	private String zCliente;
	private String nomeClasse;
	private String nomeClasseBase;
	...
	public AggiungiIndiceForm() {
		super();
	}

	public AggiungiIndiceForm(String zCliente, String nomeClasse, String nomeClasseBase, String tipologia,
			String conservazione, String nomeIndice, String tipoIndice, String valoriIndice, String numeroChiave,
			String etichettaIndice, String regole, String minValore, String minDataValore, String maxValore,
			String maxDataValore, String ltValore, String ltDataValore, String leValore, String leDataValore,
			String gtValore, String gtDataValore, String geValore, String geDataValore) {
		super();
		this.zCliente = zCliente;
		this.nomeClasse = nomeClasse;
		this.nomeClasseBase = nomeClasseBase;
	...
	public String getNomeClasseBase() {
		return nomeClasseBase;
	}

	public void setNomeClasseBase(String nomeClasseBase) {
		this.nomeClasseBase = nomeClasseBase;
	}
	...
	public String toString() {
		...
		builder.append("AggiungiIndiceForm [zCliente=");
		builder.append(zCliente);
		builder.append(", nomeClasse=");
		builder.append(nomeClasse);
		builder.append(", nomeClasseBase=");
		builder.append(nomeClasseBase);
		builder.append(", tipologia=");
		builder.append(tipologia);
		builder.append(", conservazione=");
		builder.append(conservazione);
