$(document).ready(function() {
	...
	function buildTable(identificativo_cliente, codice_scatola){
		var url = contextPath + '/archiviazione/dataTable?identificativoCliente='+identificativo_cliente+'&codiceScatola='+codice_scatola+'&_='+new Date().getTime();
	    $('#scatoleConformi').DataTable( {
	        ...
	        "columns": [
	            ...
	            { "data": "NOME_SERVIZIO" },
	            { "data": "TOT_SCATOLE_DA_ARCHIVIARE" }
	        ]
	    } );
	}
	...
	$input.typeahead({
	    source: function (query, process) {
	        return $.get(contextPath+'/archiviazione/elencoClienti', { identificativoCliente: query }, function (data) {
    ...
    $('#scatoleConformi tbody').on( 'dblclick', 'tr', function () {
    	var url = contextPath + '/archiviazione/dettaglio/';
